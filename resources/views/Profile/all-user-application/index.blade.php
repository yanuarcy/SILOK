            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="jenis-breakdown">
                        <h6 class="mb-3">
                            <i class="fas fa-chart-pie"></i> Breakdown Jenis Permohonan (Area {{ Auth::user()->role === 'Ketua RT' ? 'RT '.Auth::user()->rt : (Auth::user()->role === 'Ketua RW' ? 'RW '.Auth::user()->rw : 'Semua') }})
                        </h6>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between w-100">
                                <div>
                                    <h4>
                                        @if(Auth::user()->role === 'Ketua RT')
                                            Permohonan Area RT {{ Auth::user()->rt }}
                                        @elseif(Auth::user()->role === 'Ketua RW')
                                            Permohonan Area RW {{ Auth::user()->rw }}
                                        @else
                                            Semua Permohonan Sistem
                                        @endif
                                    </h4>
                                ...
                                <div>
                                    ...
                                    @if(in_array(Auth::user()->role, ['Ketua RT', 'Ketua RW']))
                                        <a href="{{ route('user-applications.index') }}" class="btn btn-info btn-sm">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dataApplications-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('user-applications.getDataAll') }}",
                ...
                columns: [
                    ...
                    { data: 'pemohon', name: 'nama_pemohon' },
                ...
                language: {
                    ...
                    emptyTable: `
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted small">Permohonan akan muncul di sini sesuai area akses Anda</p>
                        </div>
                    `,
                    zeroRecords: `
                        <div class="text-center my-5">
            ...
            console.log('✅ User Applications All page initialized successfully');
        });

        // Function untuk load summary data
        function loadSummaryData() {
            $.ajax({
                url: "{{ route('user-applications.getSummaryAll') }}",
                type: 'GET',
