...
<div class="container-xxl bg-white p-0">
    ...
    <div class="container">
        <div class="row g-4 mt-5 justify-content-center">
            @if($hasItems)
                @foreach ($subLayanan->items as $itemKey => $item)
                    <div class="col-md-4">
                        <a href="{{ route('Adminduk.showRegistrationOptions', [
                            'layanan' => $layananType,
                            'subLayanan' => $subLayananType,
                            'itemType' => $item->slug  // Sesuaikan dengan slug yang tepat
                        ]) }}" class="text-decoration-none">
                            <div class="card">
                                <img src="{{ asset('img/layanan/' . $item->image) }}"
                ...
                @foreach ($options as $optionKey => $option)
                    <div class="col-md-4">
                        <a href="{{ route('Adminduk.showRegistrationOptions', [
                            'layanan' => $layananType,
                            'subLayanan' => $subLayananType,
                            'itemType' => $option->slug  // Gunakan slug dari option
                        ]) }}" class="text-decoration-none">
                            <div class="card">
        ...
        <a href="{{ route('Adminduk.show', $layananType) }}"
           class="btn btn-primary mt-4">Kembali ke {{ $layanan->title }}</a>
    </div>
