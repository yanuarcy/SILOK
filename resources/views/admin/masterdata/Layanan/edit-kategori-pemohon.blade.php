        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('applicant-types.update', $applicantType->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('type') is-invalid @enderror"
                                        name="type" value="{{ old('type', $applicantType->type) }}" required>
                                    @error('type')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" value="{{ old('title', $applicantType->title) }}" required>
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($applicantType->image)
                                        <div class="mb-2">
                                            <img src="{{ asset('img/layanan/' . $applicantType->image) }}"
