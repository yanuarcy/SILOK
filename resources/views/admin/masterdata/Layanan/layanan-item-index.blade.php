                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="layanan-item-table">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Sub Layanan</th>
    ...
    <script>
        $(document).ready(function() {
            const table = $('#layanan-item-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('layanan-item.data') }}",
                columns: [
                    {data: 'id'},
                    {data: 'sub_layanan.title'},
                    {data: 'title'},
                    {
                        data: 'image',
                ...
                language: {
                    emptyTable: `
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted small">Data sub layanan item akan muncul di sini</p>
                        </div>
                    `
                }
            });
            ...
            // Delete handler
            $('#layanan-item-table').on('click', '.btn-delete', function(e) {
                e.preventDefault();
