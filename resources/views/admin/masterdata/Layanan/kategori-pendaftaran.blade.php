    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Data Kategori Pendaftaran</h1>
                <div class="section-header-button">
                    <a href="{{ route('registration-options.create') }}" class="btn btn-primary">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="registration-table">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Type</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            const table = $('#registration-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('registration-options.data') }}",
                    type: 'GET',
                ...
                columns: [
                    {data: 'id', name: 'id'}, // Tambahkan name attribute
                    {data: 'type', name: 'type'},
                ...
                language: {
                    ...
                    emptyTable: `
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted small">Data kategori pendaftaran akan muncul di sini</p>
                        </div>
                    `,
                    zeroRecords: `
                        <div class="text-center my-5">
            ...
            // Delete handler
            $('#registration-table').on('click', '.btn-delete', function(e) {
                e.preventDefault();
