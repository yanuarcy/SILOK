    ...
    <script>
        $(document).ready(function() {
                ...
                language: {
                    ...
                    emptyTable: `
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted small">Data layanan akan muncul di sini</p>
                        </div>
                    `,
                    zeroRecords: `
                        <div class="text-center my-5">
            ...
            table.on('error.dt', function(e, settings, techNote, message) {
                console.log('DataTables error event:', message);
            });

            // Delete handler
            $('#layanan-table').on('click', '.btn-delete', function(e) {
                e.preventDefault();
