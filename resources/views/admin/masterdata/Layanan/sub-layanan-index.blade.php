                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="sub-layanan-table">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Layanan</th>
    ...
    <script>
        $(document).ready(function() {
            const table = $('#sub-layanan-table').DataTable({
                ...
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'layanan.title', name: 'layanan.title'},
                    {data: 'title', name: 'title'},
                    {
                        ...
                        render: function(data) {
                            return `<img src="{{ asset('img/layanan') }}/${data}" height="50">`;
                        }
                    },
                    {
                        data: 'has_items',
                ...
                language: {
                    ...
                    emptyTable: `
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted small">Data sub layanan akan muncul di sini</p>
                        </div>
                    `
                }
            });
            ...
            // Delete handler
            $('#sub-layanan-table').on('click', '.btn-delete', function(e) {
                e.preventDefault();
