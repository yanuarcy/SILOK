    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Peraturan Perundang-undangan</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item">
                        <a href="{{ route('admin.Perpu.index') }}">Data Peraturan</a>
                    </div>
                    <div class="breadcrumb-item">Tambah Peraturan</div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Tambah Peraturan Perundang-undangan</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.Perpu.store') }}" method="POST" id="createForm" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('jenis_peraturan') is-invalid @enderror" name="jenis_peraturan">
                                                ...
                                                @foreach($jenisOptions as $jenis)
                                                    <option value="{{ $jenis }}" {{ old('jenis_peraturan') == $jenis ? 'selected' : '' }}>
                                                        {{ $jenis }}
                                                    </option>
                                                @endforeach
                                            </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('tahun') is-invalid @enderror" name="tahun">
                                                        ...
                                                        @foreach($tahunOptions as $tahun)
                                                            <option value="{{ $tahun }}" {{ old('tahun', date('Y')) == $tahun ? 'selected' : '' }}>
                                                                {{ $tahun }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('tentang') is-invalid @enderror"
                                                      name="tentang"
                                                      rows="3"
                                                      placeholder="Contoh: Standar Pelayanan Kelurahan di Lingkungan Pemerintah Kota Surabaya">{{ old('tentang') }}</textarea>
                                            @error('tentang')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="file-upload-wrapper" id="fileUploadWrapper">
                                                ...
                                                <h6 class="text-muted">Drag & Drop file PDF atau klik untuk pilih</h6>
