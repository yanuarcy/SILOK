...
@section('Dashboard')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between w-100">
                                <div>
                                    <h4>Data Pernyataan Tempat Tinggal Non Permanen (PUNTADEWA)</h4>
                                    <small class="text-muted" id="puntadewaStatusSummary">Loading...</small>
                                </div>
                                <div>
                                    <button class="btn btn-outline-primary btn-sm mr-1" onclick="refreshPuntadewaData()" title="Refresh Data">
                                        <i class="fas fa-sync-alt"></i>
                                    </button>
                                    @if(Auth::user()->role === 'user' || Auth::user()->role === 'admin')
                                    <a href="{{ route('puntadewa.create') }}" class="btn btn-primary">
                                        <i class="fas fa-plus"></i> Tambah PUNTADEWA
                                    </a>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="dataPuntadewa-table">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>File Info</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel">Detail PUNTADEWA</h5>
    ...
    <div class="modal fade" id="approveRTModal" tabindex="-1" role="dialog" aria-labelledby="approveRTModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="approveRTModalLabel">Setujui PUNTADEWA - RT</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <canvas id="ttdRTCanvas" width="300" height="150" style="border: 1px solid #ddd; width: 100%;"></canvas>
                                    <div class="mt-2">
                                        <button type="button" class="btn btn-sm btn-secondary" onclick="clearRTSignature()">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <canvas id="stempelRTCanvas" width="300" height="150" style="border: 1px solid #ddd; width: 100%;"></canvas>
                                    <div class="mt-2">
                                        <button type="button" class="btn btn-sm btn-secondary" onclick="clearRTStempel()">
                                            <i class="fas fa-eraser"></i> Hapus
                                        </button>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="approveRWModal" tabindex="-1" role="dialog" aria-labelledby="approveRWModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="approveRWModalLabel">Setujui PUNTADEWA - RW</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <canvas id="ttdRWCanvas" width="250" height="120" style="border: 1px solid #ddd; width: 100%;"></canvas>
                                    <div class="mt-2">
                                        <button type="button" class="btn btn-sm btn-secondary" onclick="clearRWSignature()">
                                            <i class="fas fa-eraser"></i> Hapus
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <canvas id="stempelRWCanvas" width="250" height="120" style="border: 1px solid #ddd; width: 100%;"></canvas>
                                    <div class="mt-2">
                                        <button type="button" class="btn btn-sm btn-secondary" onclick="clearRWStempel()">
                                            <i class="fas fa-eraser"></i> Hapus
                                        </button>
                                    </div>
                                </div>
                            ...
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    <label>Tanda Tangan Pemilik Kost/Kontrakan: <span class="text-danger">*</span></label>
                                    <canvas id="ttdPemilikKostCanvas" width="250" height="120" style="border: 1px solid #ddd; width: 100%;"></canvas>
                                    <div class="mt-2">
                                        <button type="button" class="btn btn-sm btn-secondary" onclick="clearPemilikKostSignature()">
                                            <i class="fas fa-eraser"></i> Hapus
                                        </button>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="rejectRTModal" tabindex="-1" role="dialog" aria-labelledby="rejectRTModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="rejectRTModalLabel">Tolak PUNTADEWA - RT</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="rejectRWModal" tabindex="-1" role="dialog" aria-labelledby="rejectRWModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="rejectRWModalLabel">Tolak PUNTADEWA - RW</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@push('scripts')
    ...
    <script>
        let table;
        let ttdRTPad, stempelRTPad, ttdRWPad, stempelRWPad; // ttdPemilikKostPad

        $(document).ready(function() {
            // Initialize DataTable
            table = $('#dataPuntadewa-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('puntadewa.getData') }}",
                ...
                columns: [
                    ...
                    { data: 'nama_pemohon', name: 'nama_pemohon', orderable: false },
                ...
                language: {
                    ...
                    emptyTable: `
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted small">Data PUNTADEWA akan muncul di sini</p>
                        </div>
                    `,
                    zeroRecords: `
                        <div class="text-center my-5">
            ...
            // View handler
            $('#dataPuntadewa-table').on('click', '.btn-view', function() {
                const id = $(this).data('id');
                viewDetail(id);
            });

            // RT Approve handler
            $('#dataPuntadewa-table').on('click', '.btn-approve-rt', function() {
                const id = $(this).data('id');
                const name = $(this).data('name');

                $('#approveRTModalLabel').text('Setujui PUNTADEWA - RT: ' + name);
            ...
            // RT Reject handler
            $('#dataPuntadewa-table').on('click', '.btn-reject-rt', function() {
                const id = $(this).data('id');
                const name = $(this).data('name');

                $('#rejectRTModalLabel').text('Tolak PUNTADEWA - RT: ' + name);
            ...
            // RW Approve handler
            $('#dataPuntadewa-table').on('click', '.btn-approve-rw', function() {
                const id = $(this).data('id');
                const name = $(this).data('name');

                $('#approveRWModalLabel').text('Setujui PUNTADEWA - RW: ' + name);
                ...
                clearRWSignature();
                clearRWStempel();
                // clearPemilikKostSignature();
            });

            // RW Reject handler
            $('#dataPuntadewa-table').on('click', '.btn-reject-rw', function() {
                const id = $(this).data('id');
                const name = $(this).data('name');

                $('#rejectRWModalLabel').text('Tolak PUNTADEWA - RW: ' + name);
            ...
            // Delete handler
            $('#dataPuntadewa-table').on('click', '.btn-delete', function(e) {
                e.preventDefault();
            ...
            $('#approveRTForm').on('submit', function(e) {
                ...
                if (ttdRTPad.isEmpty() || stempelRTPad.isEmpty()) {
                    Swal.fire('Error', 'Silakan lengkapi tanda tangan dan stempel RT.', 'error');
                    return;
                }

                const formData = new FormData(this);
                formData.append('ttd_rt', ttdRTPad.toDataURL());
                formData.append('stempel_rt', stempelRTPad.toDataURL());

                submitApproval(`/puntadewa/${id}/approve-rt`, formData, '#approveRTModal');
            });
            ...
            $('#rejectRTForm').on('submit', function(e) {
                ...
                submitApproval(`/puntadewa/${id}/reject-rt`, formData, '#rejectRTModal');
            });
            ...
            $('#approveRWForm').on('submit', function(e) {
                ...
                if (ttdRWPad.isEmpty() || stempelRWPad.isEmpty() ) {
                    Swal.fire('Error', 'Silakan lengkapi semua tanda tangan dan stempel.', 'error');
                    return;
                }

                const formData = new FormData(this);
                formData.append('ttd_rw', ttdRWPad.toDataURL());
                formData.append('stempel_rw', stempelRWPad.toDataURL());
                // formData.append('ttd_pemilik_kost', ttdPemilikKostPad.toDataURL());

                submitApproval(`/puntadewa/${id}/approve-rw`, formData, '#approveRWModal');
            });
            ...
            $('#rejectRWForm').on('submit', function(e) {
                ...
                submitApproval(`/puntadewa/${id}/reject-rw`, formData, '#rejectRWModal');
            });
        });
        ...
        function loadSummaryData() {
            $.ajax({
                url: "{{ route('puntadewa.getSummary') }}",
                type: 'GET',
                success: function(response) {
                    if (response.success) {
        ...
        function updateSummaryDisplay(data) {
            ...
            $('#puntadewaStatusSummary').text(statusText);
        }

        // Function untuk refresh data manual
        function refreshPuntadewaData() {
            table.ajax.reload();
            loadSummaryData();
        ...
        function initSignaturePads() {
            // RT Signature Pad
            const ttdRTCanvas = document.getElementById('ttdRTCanvas');
            if (ttdRTCanvas) {
                ttdRTPad = new SignaturePad(ttdRTCanvas, {
            ...
            // RT Stempel Pad
            const stempelRTCanvas = document.getElementById('stempelRTCanvas');
            if (stempelRTCanvas) {
                stempelRTPad = new SignaturePad(stempelRTCanvas, {
                    backgroundColor: 'rgb(255, 255, 255)',
                    penColor: 'rgb(0, 0, 0)'
                });
            }
            ...
            // RW Signature Pad
            const ttdRWCanvas = document.getElementById('ttdRWCanvas');
            if (ttdRWCanvas) {
                ttdRWPad = new SignaturePad(ttdRWCanvas, {
                    backgroundColor: 'rgb(255, 255, 255)',
                    penColor: 'rgb(0, 0, 0)'
                });
            }
            ...
            // RW Stempel Pad
            const stempelRWCanvas = document.getElementById('stempelRWCanvas');
            if (stempelRWCanvas) {
                stempelRWPad = new SignaturePad(stempelRWCanvas, {
                    backgroundColor: 'rgb(255, 255, 255)',
                    penColor: 'rgb(0, 0, 0)'
                });
            }
            ...
            // const ttdPemilikKostCanvas = document.getElementById('ttdPemilikKostCanvas');
            // if (ttdPemilikKostCanvas) {
            //     ttdPemilikKostPad = new SignaturePad(ttdPemilikKostCanvas, {
            //         backgroundColor: 'rgb(255, 255, 255)',
            //         penColor: 'rgb(0, 0, 0)'
            //     });
            // }
        ...
        function clearRTSignature() {
            if (ttdRTPad) ttdRTPad.clear();
        }

        function clearRTStempel() {
            if (stempelRTPad) stempelRTPad.clear();
        }

        function clearRWSignature() {
            if (ttdRWPad) ttdRWPad.clear();
        }

        function clearRWStempel() {
            if (stempelRWPad) stempelRWPad.clear();
        }

        // function clearPemilikKostSignature() {
        //     if (ttdPemilikKostPad) ttdPemilikKostPad.clear();
        // }
    </script>
