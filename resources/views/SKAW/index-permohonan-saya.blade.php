{{-- resources/views/Skaw/index-permohonan-saya.blade.php --}}
...
@push('style')
    ...
    <style>
        ...
        .summary-card.draft { border-left-color: #6c757d; }
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <div class="card summary-card draft border-0 shadow-sm">
                        <div class="card-body text-center">
                            <i class="fas fa-edit fa-2x text-secondary mb-2"></i>
                            <h6 class="card-title text-muted">Draft</h6>
                            <h4 class="text-secondary mb-0" id="draftCount">-</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                            ...
                            <div class="d-flex justify-content-between w-100">
                                ...
                                <div>
                                    ...
                                    @if(in_array($userRole, ['user', 'admin']))
                                        <a href="{{ route('skaw.create') }}" class="btn btn-primary">
                                            <i class="fas fa-plus"></i> Buat SKAW
                                        </a>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="col-12">
                    <div class="card border-info">
                        <div class="card-header bg-info text-white">
                            <h6 class="mb-0"><i class="fas fa-info-circle mr-2"></i>Informasi Workflow SKAW</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h6 class="text-primary">Tahapan Proses SKAW:</h6>
                                    <ol class="small">
                                        <li><strong>Pengajuan:</strong> Pemohon mengisi form dan mengajukan</li>
                                        <li><strong>Front Office:</strong> Validasi dan approval front office</li>
                                        <li><strong>Generate Dokumen:</strong> Tanda terima dan draft SKAW dibuat</li>
                                        <li><strong>Jadwal Sidang:</strong> Front office membuat jadwal sidang</li>
                                        <li><strong>Sidang:</strong> Pelaksanaan sidang (upload evidence setelah hari H)</li>
                                        <li><strong>Approval Lurah:</strong> Lurah menyetujui hasil sidang</li>
                                        <li><strong>Approval Camat:</strong> Camat menyetujui final</li>
                                        <li><strong>SKAW Final:</strong> Back office upload dokumen final</li>
                                    </ol>
                                </div>
                                <div class="col-md-6">
                                    <h6 class="text-primary">Status Tracking:</h6>
                                    <ul class="small">
                                        <li><span class="badge badge-secondary">Draft</span> - Masih dalam tahap penyusunan</li>
                                        <li><span class="badge badge-primary">Diajukan</span> - Menunggu review front office</li>
                                        <li><span class="badge badge-info">Front Office Approved</span> - Disetujui front office</li>
                                        <li><span class="badge badge-warning">SKAW Generated</span> - Dokumen draft dibuat</li>
                                        <li><span class="badge badge-primary">Jadwal Sidang</span> - Jadwal sidang telah dibuat</li>
                                        <li><span class="badge badge-info">Sidang Selesai</span> - Sidang telah dilaksanakan</li>
                                        <li><span class="badge badge-success">Selesai</span> - SKAW final tersedia</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
                ...
                language: {
                    ...
                    emptyTable: `
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted small">Buat permohonan SKAW baru dengan klik tombol "Buat SKAW"</p>
                        </div>
                    `,
                    zeroRecords: `
                        <div class="text-center my-5">
        ...
        function updateSummaryDisplay(data) {
            ...
            let statusText = `Total: ${data.total_pengajuan || 0} | Draft: ${data.draft || 0} | Proses: ${data.sedang_proses || 0} | Selesai: ${data.selesai || 0}`;
